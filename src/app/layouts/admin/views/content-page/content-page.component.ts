...
} from '@admin/components/content-section/content-section.component';
import { OrderedCvContentListComponent } from '@admin/components/ordered-cv-content-list/ordered-cv-content-list.component';
import { AdminSkillsSectionComponent } from '@admin/components/skills-section/skills-section.component';
